...
# Repository: https://github.com/sadeeqtheanatomist/BIOINFORMATICS-COLLABORATIVE-PROJECT_GROUP-EIGHTEEN
# Group: Eighteen
# ==============================================================================

# Step 1: Clone the repository to local machine
echo "=== Cloning Group Eighteen's Repository ==="
git clone https://github.com/sadeeqtheanatomist/BIOINFORMATICS-COLLABORATIVE-PROJECT_GROUP-EIGHTEEN.git
cd BIOINFORMATICS-COLLABORATIVE-PROJECT_GROUP-EIGHTEEN || exit  # Exit if folder not found
